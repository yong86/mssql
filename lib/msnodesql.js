...
(function() {
  ...
  msnodesql = require('node-sqlserver');
  ...
  //CONNECTION_STRING_PORT = 'Driver={SQL Server Native Client 11.0};Server={#{server},#{port}};Database={#{database}};Uid={#{user}};Pwd={#{password}};Trusted_Connection={#{trusted}};';
      CONNECTION_STRING_PORT = 'Driver={SQL Server Native Client 11.0};Server={#{server},#{port}};Database=#{database};Uid={#{user}};Pwd={#{password}};Encrypt=#{encrypt};Connection Timeout=#{timeout};'
